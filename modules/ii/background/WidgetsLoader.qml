...
Item {
    ...
    Repeater {
        model: Config.options.background.widgets.customImage.enable
            && (Config.options.background.widgets.customImage.images && Config.options.background.widgets.customImage.images.length > 0)
            && root.onThisScreen
    ...
    Component {
        id: customImageComp
        CustomImage {
            visible: !Config.options.background.widgets.customImage.images || Config.options.background.widgets.customImage.images.length === 0
            screenWidth: root.screen.width
            screenHeight: root.screen.height
            scaledScreenWidth: root.screen.width
            scaledScreenHeight: root.screen.height
