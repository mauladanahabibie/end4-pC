...
hl.bind("SHIFT + SUPER + ALT + Slash", hl.dsp.exec_cmd("qs -p $HOME/.config/quickshell/$qsConfig/welcome.qml"), { description = "Shell: Welcome screen" })

hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd(qsIpcCall .. " brightness increment || brightnessctl s 5%+"),
    { locked = true, repeating = true, description = "Shell: Brightness up" })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd(qsIpcCall .. " brightness decrement || brightnessctl s 5%-"),
    { locked = true, repeating = true, description = "Shell: Brightness down" })
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 2%+ -l 1.5"),
    { locked = true, repeating = true, description = "Shell: Volume up" })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("wpctl set-volume @DEFAULT_AUDIO_SINK@ 2%-"),
    { locked = true, repeating = true, description = "Shell: Volume down" })
...
hl.bind("SUPER + Semicolon", hl.dsp.layout("splitratio -0.1"), { repeating = true, description = "Window: Decrease split ratio" })
hl.bind("SUPER + Apostrophe", hl.dsp.layout("splitratio +0.1"), { repeating = true, description = "Window: Increase split ratio" })
--# Positioning mode
...
hl.bind("SUPER + P", hl.dsp.global("quickshell:displayProjectionToggle"), { description = "Shell: Display projection" })
...
hl.bind("SUPER + mouse:275", hl.dsp.workspace.toggle_special("special"), { mouse = true, description = "Workspace: Toggle scratchpad" })
for i = 1, 4 do
...
hl.define_submap("virtual-machine", function()
    ...
    end, { submap_universal = true, description = "Virtual machines: Toggle keybinds" })
end)
...
hl.bind("SUPER + T", hl.dsp.exec_cmd(terminal), { description = "Execute: terminal" })
...
hl.bind("CTRL + SUPER + Backslash", hl.dsp.window.resize({ x = 640, y = 480, "exact" }), { description = "Window: Reset size" })
